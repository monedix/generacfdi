...
function CancelTest(strUserName, strPassword, CanB64) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield axios_1.default.post(constants_1.RVLTIMBRADO.URL_CANCEL_TEST, {
                strUserName,
                strPassword,
                CanB64
            });
