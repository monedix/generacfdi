...
function Consultar_credenciales_usuario_rv(rfc_consultar, Clave_admin) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield axios_1.default.post(constants_1.WS_CONSULTAS_CFD_REAL.URL_CONSULTAR_CREDENCIALES_USUARIO_RV, {
                rfc_consultar,
                Clave_admin
            });
            return response;
...
exports.default = Consultar_credenciales_usuario_rv;
