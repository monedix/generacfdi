...
function Consultar_serie_folio_rfc_emisor(rfc_emisor, serie, folio, Usuario_admin, Clave_admin, rfc_admin) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield axios_1.default.post(constants_1.WS_CONSULTAS_CFD_REAL.URL_CONSULTAR_SERIE_FOLIO_RFC_EMISOR, {
                rfc_emisor,
                serie,
                folio,
                Usuario_admin,
...
exports.default = Consultar_serie_folio_rfc_emisor;
