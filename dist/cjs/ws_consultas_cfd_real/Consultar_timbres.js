...
function Consultar_timbres(rfc) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield axios_1.default.post(constants_1.WS_CONSULTAS_CFD_REAL.URL_CONSULTAR_TIMBRES, {
                rfc
            });
            return response;
        }
...
exports.default = Consultar_timbres;
